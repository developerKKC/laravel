            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {!! Form::open(['action'=>'NakliyeciController@ekle']) !!}
                            ...
                            <div class="form-group{{ $errors->has('tip') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="tip" class="form-control" name="tip" value="{{ old('tip') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('plaka') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="plaka" type="text" class="form-control" name="plaka" value="{{ old('plaka') }}" required autofocus>
