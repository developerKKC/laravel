...
<head>
    ...
    <title><?php echo e(config('laravel', 'Nakliyat')); ?></title>
                            ...
                            <?php else: ?>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li>
                                            <a href="<?php echo e(url('ilanlarim')); ?>">
                                                İlanlarım
                                            </a>
                                        ...
                                        <li>
                                            <a href="<?php echo e(url('/tamamlananlar')); ?>">
                                        ...
                                        <li>
                                            <a href="<?php echo e(url('/nakliyecikayit')); ?>">
                                                Nakliyeci Kayıt
                                            </a>
...
<?php } ?>
                                        ...
                                        <li>
                                            <a href="<?php echo e(url('/tekliflerim')); ?>">
                                                Aktif Tekliflerim
                                            </a>
                                        ...
                                        <li>
                                            <a href="<?php echo e(url('/tamamlanantasimalarim')); ?>">
