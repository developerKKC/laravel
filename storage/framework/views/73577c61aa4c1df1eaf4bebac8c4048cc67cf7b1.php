            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('telno') ? ' has-error' : ''); ?>">
                            <label for="telno" class="col-md-4 control-label">Telefon</label>

                            <div class="col-md-6">
                                <input id="telno" type="text" class="form-control" name="telno" value="<?php echo e(old('telno')); ?>" required>

                                <?php if($errors->has('telno')): ?>
                                    <span class="help-block">
                                        <strong><?php echo e($errors->first('telno')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
